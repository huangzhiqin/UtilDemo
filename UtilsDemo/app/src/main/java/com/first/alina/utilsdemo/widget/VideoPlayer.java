...
public abstract class VideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    protected VideoPlayer.ProgressTimerTask mProgressTimerTask;
...
//                        mDownY = y;
    ...
    public void clearFloatScreen() {
        ...
        ViewGroup vp = (JZUtils.scanForActivity(getContext()))//.getWindow().getDecorView();
                .findViewById(Window.ID_ANDROID_CONTENT);
        JZVideoPlayer fullJzvd = vp.findViewById(cn.jzvd.R.id.jz_fullscreen_id);
        JZVideoPlayer tinyJzvd = vp.findViewById(cn.jzvd.R.id.jz_tiny_id);
    ...
    public void startProgressTimer() {
        ...
        mProgressTimerTask = new VideoPlayer.ProgressTimerTask();
