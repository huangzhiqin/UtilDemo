...
import com.first.alina.utilsdemo.adapters.AdapterVideoListAdapter;
...
public class ActivityListViewNormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listView.setAdapter(new AdapterVideoListAdapter(this,
                mVideoList));
