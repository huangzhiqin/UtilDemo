...
import com.first.alina.utilsdemo.video.adapters.CustomMediaPlayer.CustomMediaPlayerAssertFolder;
import com.first.alina.utilsdemo.video.adapters.CustomMediaPlayer.JZMediaIjkplayer;
...
public class ActivityApiCustomMediaPlayer  extends AppCompatActivity implements View.OnClickListener {
    ...
    private String videoUrl="http://image.cailianpress.com/admin/20180323/111944tT9Usc76pUCf.mp4";
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        jzVideoPlayerStandard.setUp(videoUrl,JZVideoPlayerStandard.SCREEN_WINDOW_NORMAL, "饺子快长大");
        Glide.with(this)
